...
/* harmony import */ var _modules_picture__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/picture */ "./src/js/modules/picture.js");
"Use strict";
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_picture__WEBPACK_IMPORTED_MODULE_6__["default"])();
});
...
function form(form, element, obj) {
  ...
  function checkInput() {
    var inp = document.querySelectorAll(element);
...
function modal(trigger, close, modal) {
  ...
  var trigger1 = document.querySelectorAll(trigger),
  ...
  function showModal(e) {
    e.preventDefault();
    windows.forEach(function (modal) {
